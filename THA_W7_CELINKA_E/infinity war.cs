...
{
    public partial class infinity_war : Form
    {
        Panel infinitywar = new Panel();
        ...
        private void infinity_war_Load(object sender, EventArgs e)
        {
            //Label judul 
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(5, 20);
            movie1.Name = "Avenger Infinity War";
            movie1.Size = new Size(300, 300);
            movie1.TabIndex = 1;
            movie1.Text = "Avenger Infinity War";
            Controls.Add(movie1);
            movie1.Click += Movie1_Click;

            //poster
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = Properties.Resources.Avenger_infinity_war;
            ...
            jam1.Name = "Avenger Infinity War";
            ...
            jam2.Name = "Avenger Infinity War";
            ...
            jam3.Name = "Avenger Infinity War";
            ...
            //panel milih kursi
            infinitywar.Location = new Point(340, 25);
            infinitywar.Name = "panel1";
            infinitywar.Size = new Size(280, 300);
            infinitywar.TabIndex = 0;
            infinitywar.BackColor = Color.BurlyWood;
            Controls.Add(infinitywar);


            //jam 15.00
            infinitywar.Controls.Clear();
            for (int i = 0; i < 10; i++)
            {
                for (int a = 0; a < 10; a++)
                {
