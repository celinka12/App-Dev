...
{
    public partial class train_to_busan : Form
    {
         Panel traintobusan = new Panel();
        ...
        private void train_to_busan_Load(object sender, EventArgs e)
        {
            //Label judul 
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(5, 20);
            movie1.Name = "Train to Busan";
            movie1.Size = new Size(300, 300);
            movie1.TabIndex = 1;
            movie1.Text = "Train to Busan";
            Controls.Add(movie1);
            movie1.Click += Movie1_Click;

            //poster
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = Properties.Resources.TraintoBusan;
            ...
            //panel milih kursi
            traintobusan.Location = new Point(340, 25);
            traintobusan.Name = "panel1";
            traintobusan.Size = new Size(280, 300);
            traintobusan.TabIndex = 0;
            traintobusan.BackColor = Color.BurlyWood;
            Controls.Add(traintobusan);

            //jam 15.00
            traintobusan.Controls.Clear();
            for (int i = 0; i < 10; i++)
            {
                for (int a = 0; a < 10; a++)
                {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                traintobusan.Controls.Add(seat);
            }
