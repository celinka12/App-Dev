...
{
    public partial class iron_man_1 : Form
    {
        Panel ironMan1 = new Panel();
        ...
        private void iron_man_1_Load(object sender, EventArgs e)
        {
            //Label judul 
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(5, 20);
            movie1.Name = "Iron Man 1";
            movie1.Size = new Size(300, 300);
            movie1.TabIndex = 1;
            movie1.Text = "Iron Man 1";
            Controls.Add(movie1);
            movie1.Click += Movie1_Click;

            //poster
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = Properties.Resources.IronMan1;
            ...
            //panel milih kursi
            ironMan1.Location = new Point(340, 25);
            ironMan1.Name = "panel1";
            ironMan1.Size = new Size(280, 300);
            ironMan1.TabIndex = 0;
            ironMan1.BackColor = Color.BurlyWood;
            Controls.Add(ironMan1);

            //jam 15.00
            ironMan1.Controls.Clear();
            for (int i = 0; i < 10; i++)
            {
                for (int a = 0; a < 10; a++)
                {
