...
{
    public partial class JamTayang : Form
    {
        Panel quiteplace = new Panel();
        ...
        private void JamTayang_Load(object sender, EventArgs e)
        {
            //Label judul 1
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(5, 20);
            movie1.Name = "A Quiet Place";
            movie1.Size = new Size(300, 300);
            movie1.TabIndex = 1;
            movie1.Text = "A Quiet Place";
            Controls.Add(movie1);
            ...
            pictureBox1.Image = Properties.Resources.A_quiet_Place;
            ...
            //panel milih kursi
            quiteplace.Location = new Point(340, 25);
            quiteplace.Name = "panel1";
            quiteplace.Size = new Size(280, 300);
            quiteplace.TabIndex = 0;
            quiteplace.BackColor = Color.BurlyWood;
            Controls.Add(quiteplace);
