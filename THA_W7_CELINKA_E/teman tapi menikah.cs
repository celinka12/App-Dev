...
{
    public partial class teman_tapi_menikah : Form
    {
        Panel ttm = new Panel();
        ...
        private void teman_tapi_menikah_Load(object sender, EventArgs e)
        {
            //Label judul 
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(5, 20);
            movie1.Name = "Teman Tapi Menikah";
            movie1.Size = new Size(300, 300);
            movie1.TabIndex = 1;
            movie1.Text = "Teman Tapi Menikah";
            Controls.Add(movie1);
            movie1.Click += Movie1_Click;

            //poster
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = Properties.Resources.Teman_tapi_menikah;
            ...
            //panel milih kursi
            ttm.Location = new Point(340, 25);
            ttm.Name = "panel1";
            ttm.Size = new Size(280, 280);
            ttm.TabIndex = 0;
            ttm.BackColor = Color.BurlyWood;
            Controls.Add(ttm);
